 ...
 * @author Usuario
 */
public class ListarContenidos extends javax.swing.JInternalFrame {

    GestionContenidos gc = new GestionContenidos();
    ...
    private void CargarContenidos() {
        try {
            ...
            gc.listarContenidos().forEach((u) -> model.addRow(new Object[]{u.getCodigo(), u.getNombre(), u.getDescripccion(), u.getObservaciones()}));
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        tblContenidos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nombre", "Descripción", "Observaciones"
            }
        ) {
