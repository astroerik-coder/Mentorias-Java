...
public class ListarProductos extends javax.swing.JInternalFrame {
    ...
    private void CargarContenidos() {
        try {
            ...
            gc.listarProductos().forEach((u) -> model.addRow(
                    new Object[]{
                        u.getId(),u.getNombre(),u.getDescripcion(),u.getPrecio()
                            ,u.getObservaciones(),u.getId_emp()}));
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        tblProductos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nombre", "Descripción", "Precio", "Id_Emprendedor", "Nombre Emprendedor"
            }
        ) {
